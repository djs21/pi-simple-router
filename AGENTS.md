...
| Path | Scope |
|---|---|
| `docs/` | Project documentation, plans, ADRs, PRDs. See `docs/plan.md` for implementation plan, `docs/prd-error-state-invisibility.md` for the error invisibility PRD, and `docs/prd-cooldown-escalation.md` for the escalating cooldown + SQLite backend PRD. |
